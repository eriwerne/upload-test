...
public class When_processing_image_order_with_one_article_and_one_container {
    @Test
    public void then_expect_given_expectation() throws ApplicationFailed {
        new SystemTest()
                .forOrderNumber("12345")
                .worksWithDirectory("systemtest/single_article_tests/one_article_one_container")
